...
//Conexión Api WIki
 ...
 const input = this.$el.querySelector('#entradas');
 const submitButton = Vue.selector('#submit');
 const errorSpan = this.$el.querySelector('#error');
 const resultsContainer = this.$el.querySelector('#results');
 //registro de eventos
